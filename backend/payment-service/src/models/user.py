...
class PaymentMethod(db.Model):
    ...
    type = db.Column(db.String(50), nullable=False)  # card, bank_account, digital_wallet
    ...
    # Relationships
    transactions = db.relationship('Transaction', backref='payment_method', cascade='all, delete-orphan')
...
class Transaction(db.Model):
    ...
    transaction_type = db.Column(db.String(50), nullable=False)  # payment, refund, transfer, withdrawal
    amount = db.Column(db.Numeric(15, 2), nullable=False)
    currency = db.Column(db.String(3), default='USD')
    description = db.Column(db.Text)
    reference = db.Column(db.String(100))
    status = db.Column(db.String(50), nullable=False)  # pending, processing, completed, failed, cancelled
...
class Wallet(db.Model):
    ...
    # Relationships
    balance_history = db.relationship('WalletBalanceHistory', backref='wallet', cascade='all, delete-orphan')
...
class WalletBalanceHistory(db.Model):
    ...
    change_type = db.Column(db.String(50), nullable=False)  # credit, debit, hold, release
    amount = db.Column(db.Numeric(15, 2), nullable=False)
...
class PaymentProcessor(db.Model):
    ...
    provider_type = db.Column(db.String(50), nullable=False)  # stripe, paypal, square, etc.
    supported_methods = db.Column(db.JSON, nullable=False)  # List of supported payment methods
    supported_currencies = db.Column(db.JSON, nullable=False)  # List of supported currencies

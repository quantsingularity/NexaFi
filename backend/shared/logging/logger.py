...
class LoggerManager:
    ...
    def log_request_end(self, logger: logging.Logger, status_code: int, response_time: float):
        """Log request end"""
        if has_request_context():
            logger.info(
                "Request completed",
    ...
    def log_financial_transaction(self, logger: logging.Logger, transaction_type: str, 
                                amount: str, currency: str, transaction_id: str,
    ...
    def log_api_call(self, logger: logging.Logger, service: str, endpoint: str,
...
def log_financial_transaction(transaction_type: str, amount: str, currency: str, 
                            transaction_id: str, details: Optional[Dict[str, Any]] = None):
    """Log financial transaction"""
    logger = get_logger('financial')
    logger_manager.log_financial_transaction(logger, transaction_type, amount, currency, transaction_id, details)

...
class AuditLogger:
    ...
    def _write_to_file(self, event_data: Dict[str, Any]):
        ...
        log_file = f'/home/ubuntu/nexafi_backend_refactored/logs/audit/audit_{date_str}.jsonl'
    ...
    def log_user_action(self, event_type: AuditEventType, user_id: str, action: str, 
    ...
    def log_financial_transaction(self, event_type: AuditEventType, user_id: str, 
                                transaction_id: str, amount: str, currency: str,
                                details: Optional[Dict[str, Any]] = None, **kwargs):
    ...
    def log_api_access(self, user_id: Optional[str], endpoint: str, method: str,
                      status_code: int, ip_address: str, user_agent: str,

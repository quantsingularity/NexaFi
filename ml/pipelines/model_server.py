...
class ModelCache:
    ...
    def put_model(self, model_name: str, version: str, model: BaseEstimator) -> Any:
    ...
    def _evict_model(self, key: str) -> Any:
...
class ModelServer:
    ...
    def run(self, host: str = "0.0.0.0", port: int = 8080, debug: bool = False) -> Any:

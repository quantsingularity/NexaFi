...
class CreditScorer:
    ...
    def predict(self, X_new):
        ...
        return self.model.predict_proba(X_new)[:, 1] # Probability of being 'good' credit
...
if __name__ == '__main__':
    ...
    data = {
        ...
        'income': [50000, 60000, 70000, 80000, 90000, 100000, 110000, 120000, 55000, 65000],
        'loan_amount': [10000, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 12000, 18000],
        'education': ['high_school', 'university', 'university', 'graduate', 'graduate', 'university', 'graduate', 'university', 'high_school', 'university'],

...
if __name__ == '__main__':
    ...
    products_data = [
        ...
        {'product_id': 'P005', 'description': 'Mortgage loan with competitive interest rates.'},
        {'product_id': 'P006', 'description': 'Personal loan for debt consolidation.'},
        {'product_id': 'P007', 'description': 'Retirement planning service with financial advisors.'},
    ]
    ...
    recommendations_2 = recommender.recommend_products(user_pref_2, num_recommendations=1)
    print("\nRecommended Products for user preferences:\n", user_pref_2)

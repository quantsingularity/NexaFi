...
class TestJournalEntryModel:
    ...
    def test_journal_entry_validation(self):
        ...
        db.session.commit()
        # NOTE: This assumes a validate_entry method exists on the JournalEntry model that sums up the lines
        ...
        db.session.commit()
        # NOTE: This assumes a validate_entry method exists on the JournalEntry model

...
class TestAccountRoutes:
    ...
    def test_create_account_success(self, client):
        ...
        with app.app_context():
            account = Account.query.filter_by(user_id=\'test_user_1\', account_code=\'1010\').first()
    ...
    def test_get_account_success(self, client):
        ...
        account = create_test_account(\'test_user_2\', \'2000\', \'Savings Account\', \'asset\', \'debit\')
    ...
    def test_get_account_not_found(self, client):
        headers = {\'X-User-ID\': \'test_user_2\''}
        response = client.get(
            \'/api/v1/accounts/non_existent_id\',
            headers=headers
        )
    ...
    def test_update_account_success(self, client):
        ...
        account = create_test_account(\'test_user_3\', \'3000\', \'Old Name\', \'asset\', \'debit\')
...
class TestJournalEntryRoutes:
    ...
    def test_create_journal_entry_success(self, client):
        ...
        cash_account = create_test_account(\'test_user_5\', \'1000\', \'Cash\', \'asset\', \'debit\')
        revenue_account = create_test_account(\'test_user_5\', \'4000\', \'Revenue\', \'revenue\', \'credit\')
    ...
    def test_create_journal_entry_unbalanced(self, client):
        ...
        cash_account = create_test_account(\'test_user_6\', \'1000\', \'Cash\', \'asset\', \'debit\')
        revenue_account = create_test_account(\'test_user_6\', \'4000\', \'Revenue\', \'revenue\', \'credit\')
    ...
    def test_post_journal_entry_success(self, client):
        ...
        cash_account = create_test_account(\'test_user_7\', \'1000\', \'Cash\', \'asset\', \'debit\')
        revenue_account = create_test_account(\'test_user_7\', \'4000\', \'Revenue\', \'revenue\', \'credit\')
        ...
        line1 = JournalEntryLine(journal_entry_id=entry.id, account_id=cash_account.id, debit_amount=100.00)
        line2 = JournalEntryLine(journal_entry_id=entry.id, account_id=revenue_account.id, credit_amount=100.00)
    ...
    def test_post_journal_entry_not_found(self, client):
        headers = {\'X-User-ID\': \'test_user_7\''}
        response = client.post(
            \'/api/v1/journal-entries/non_existent_id/post\',
            headers=headers
        )
        assert response.status_code == 404
...
class TestFinancialReportsRoutes:
    ...
    def test_get_trial_balance_success(self, client):
        ...
        cash_account = create_test_account(\'test_user_9\', \'1000\', \'Cash\', \'asset\', \'debit\')
        revenue_account = create_test_account(\'test_user_9\', \'4000\', \'Revenue\', \'revenue\', \'credit\')
    ...
    def test_get_income_statement_success(self, client):
        ...
        revenue_account = create_test_account(\'test_user_10\', \'4000\', \'Sales Revenue\', \'revenue\', \'credit\')
        expense_account = create_test_account(\'test_user_10\', \'6000\', \'Salaries Expense\', \'expense\', \'debit\')
        ...
        db.session.flush()
        line1_1 = JournalEntryLine(journal_entry_id=entry1.id, account_id=revenue_account.id, credit_amount=500.00)
        line1_2 = JournalEntryLine(journal_entry_id=entry1.id, account_id=expense_account.id, debit_amount=500.00) # Dummy for balance
        ...
        db.session.flush()
        line2_1 = JournalEntryLine(journal_entry_id=entry2.id, account_id=expense_account.id, debit_amount=200.00)
        line2_2 = JournalEntryLine(journal_entry_id=entry2.id, account_id=revenue_account.id, credit_amount=200.00) # Dummy for balance
        ...
        response = client.get(
            ...
            headers=headers,
            query_string={\'start_date\': date.today().isoformat(), \'end_date\': date.today().isoformat()}
        )
        assert response.status_code == 200
        json_data = response.get_json()
    ...
    def test_get_balance_sheet_success(self, client):
        ...
        cash_account = create_test_account(\'test_user_11\', \'1000\', \'Cash\', \'asset\', \'debit\')
        ap_account = create_test_account(\'test_user_11\', \'2000\', \'Accounts Payable\', \'liability\', \'credit\')
        equity_account = create_test_account(\'test_user_11\', \'3000\', \'Owner\'s Equity\', \'equity\', \'credit\')
        ...
        db.session.add(entry1)
        db.session.flush()
        line1_1 = JournalEntryLine(journal_entry_id=entry1.id, account_id=cash_account.id, debit_amount=1000.00)
        line1_2 = JournalEntryLine(journal_entry_id=entry1.id, account_id=equity_account.id, credit_amount=1000.00)
        db.session.add_all([line1_1, line1_2])
        db.session.commit()
...
class TestFinancialPeriodRoutes:
    ...
    def test_create_financial_period_success(self, client):
        ...
        with app.app_context():
            period = FinancialPeriod.query.filter_by(user_id=\'test_user_12\', period_name=\'Q1 2024\').first()
    ...
    def test_close_financial_period_success(self, client):
        ...
        response = client.post(
            f\'/api/v1/financial-periods/{period.id}/close\',
            headers=headers
        )
        assert response.status_code == 200
        json_data = response.get_json()
...
class TestBudgetRoutes:
    ...
    def test_create_budget_success(self, client):
        ...
        with app.app_context():
            budget = Budget.query.filter_by(user_id=\'test_user_14\', budget_name=\'Marketing Budget 2024\').first()
    ...
    def test_get_budget_performance_success(self, client):
        ...
        # Simulate some expenses (e.g., via journal entries affecting expense accounts)
        # For simplicity, we'll mock the get_account_balance method
        with patch(\'NexaFi.backend.ledger_service.src.models.user.Account.get_balance\') as mock_get_balance:
            mock_get_balance.return_value = -1500.00 # Simulate 1500 spent on an expense account
            expense_account = create_test_account(\'test_user_15\', \'6000\', \'Travel Expense\', \'expense\', \'debit\')

            response = client.get(
                f\'/api/v1/budgets/{budget.id}/performance\',
                headers=headers
            )
            assert response.status_code == 200
            json_data = response.get_json()
